"""
Convert a portrait photo into a CLEAN, monochrome ASCII-art SVG (Tanishq4258
...
FRAME = "#30363d"
TITLE_TEXT = "#7d8590"
INK = "#c9d1d9"      # the single ascii color (matches Tanishq4258)
CURSOR = "#c9d1d9"
...
parts.append(f'<text x="{CANVAS_W/2}" y="{TITLEBAR_H/2 + 4}" fill="{TITLE_TEXT}" font-size="12" '
             f'text-anchor="middle">Tanishq4258@github: ~$ ./portrait.sh</text>')
...
parts.append(f'<text x="{PAD}" y="{status_y:.1f}" fill="{TITLE_TEXT}" font-size="13">'
             f'Tanishq4258@github:~$ whoami <tspan fill="{INK}">Tanishq Chhabra</tspan></text>')
